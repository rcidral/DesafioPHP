                ...
                <div style="width:600px; height: 400px;" class="product">
                    <div style="width:300px; height: 200px;"  class="product-img">
                        ...
                        <div style="position: relative; top: 25px; left:125px" class="secundary">
                            <img style="width: 120px;" onclick="openProduct(<?= $produto['id']?>)" src="data:image/png;base64,<?=$produto['img1']?>" alt="product">
                            <img style="width: 120px;" onclick="openProduct(<?= $produto['id']?>)" src="data:image/png;base64,<?=$produto['img2']?>" alt="product">
                            <img style="width: 120px;" onclick="openProduct(<?= $produto['id']?>)" src="data:image/png;base64,<?=$produto['img3']?>" alt="product">
                        </div>
                    </div>
